!(function (n) {
  ...
  function (e, t) {
    ...
    function r() {
      u && u.classList.toggle("hidden", !n()),
        i && i.classList.toggle("hidden", n()),
        d && d.classList.toggle("hidden", !n());
    }
    ...
    i &&
      ...
      document.body.addEventListener("click", function () {
        n() || !d || d.classList.contains("hidden")
          ? n() && !i.classList.contains("hidden") && i.classList.add("hidden")
      ...
      c &&
        c.addEventListener("click", function (e) {
          e.stopPropagation(),
            ...
            d.getBoundingClientRect().right > o.getBoundingClientRect().right &&
              ((d.style.left = "auto"), (d.style.right = 0));
        });
  },
]);
