  ...
  function (we, e, ke) {
    (function (e) {
      var t,
        ...
        k = (function (d) {
            ...
            N = {
              ...
              languages: {
                ...
                insertBefore: function (n, e, t, a) {
                  ...
                  return (
                    (a[n] = i),
                    N.languages.DFS(N.languages, function (e, t) {
                      t === l && e != n && (this[e] = i);
                    }),
                    i
                  );
                ...
                DFS: function e(t, n, a, r) {
                  ...
                  for (var l in t) {
                    t.hasOwnProperty(l) &&
                      (n.call(t, l, t[l], a || l),
                      (i = t[l]),
                      "Object" !== (o = N.util.type(i)) || r[s(i)]
                        ? "Array" !== o ||
                          r[s(i)] ||
                          ((r[s(i)] = !0), e(i, n, l, r))
                        : ((r[s(i)] = !0), e(i, n, null, r)));
                  }
                },
              },
              plugins: {},
              ...
              highlightAllUnder: function (e, t, n) {
                ...
                N.hooks.run("before-highlightall", a),
                  ...
                  N.hooks.run("before-all-elements-highlight", a);
                for (var r, i = 0; (r = a.elements[i++]); )
                  N.highlightElement(r, !0 === t, a.callback);
              },
              highlightElement: function (e, t, n) {
                ...
                if ((N.hooks.run("before-sanity-check", s), !s.code))
                  return (
                    N.hooks.run("complete", s), void (n && n.call(s.element))
                  );
                N.hooks.run("before-highlight", s),
                  s.grammar
                    ? t && d.Worker
                      ? (((o = new Worker(N.filename)).onmessage = function (
                          e
                        ) {
                          l(e.data);
                        }),
                      ...
                      : l(N.highlight(s.code, s.grammar, s.language))
                    : l(N.util.encode(s.code));
              },
                  ...
                  (function e(t, n, a, r, i, o) {
                    for (var s in a)
                      if (a.hasOwnProperty(s) && a[s])
                        for (
                          var l = a[s], l = Array.isArray(l) ? l : [l], d = 0;
                          d < l.length;
                          ++d
                        ) {
                          ...
                          for (
                            var h = c.pattern || c, y = r.next, v = i;
                            y !== n.tail && !(o && v >= o.reach);
                            ...
                            if (!(w instanceof O)) {
                              var k,
                                ...
                                _ = 1;
                              if (f && y != n.tail.prev) {
                                if (((h.lastIndex = v), !(I = h.exec(t))))
                                  break;
                                var T = I.index + (g && I[1] ? I[1].length : 0),
                                  C = I.index + I[0].length,
                                  R = v;
                                for (R += y.value.length; R <= T; )
                                  R += (y = y.next).value.length;
                                if (
                                  ((v = R -= y.value.length),
                                  y.value instanceof O)
                                )
                                  continue;
                                for (
                                  var L = y;
                                  L !== n.tail &&
                                  (R < C || "string" == typeof L.value);
                                  L = L.next
                                )
                                  _++, (R += L.value.length);
                              ...
                              I &&
                                (g && (m = I[1] ? I[1].length : 0),
                                (C =
                                  (T = I.index + m) +
                                  (k = I[0].slice(m)).length),
                                (S = w.slice(0, T)),
                                (E = w.slice(C)),
                                (x = v + w.length),
                                o && x > o.reach && (o.reach = x),
                                (A = y.prev),
                                S && ((A = F(n, A, S)), (v += S.length)),
                                (function (e, t, n) {
                                  for (
                                    var a = t.next, r = 0;
                                    r < n && a !== e.tail;
                                ...
                                (y = F(
                                  n,
                                  A,
                                  new O(s, p ? N.tokenize(k, p) : k, b, k)
                                )),
                                E && F(n, y, E),
                                1 < _ &&
                                  e(t, n, a, y.prev, v, {
                  ...
                  d.addEventListener(
                    ...
                    function (e) {
                      var t = JSON.parse(e.data),
                        ...
                        a = t.code,
                        r = t.immediateClose;
                      d.postMessage(N.highlight(a, N.languages[n], n)),
                        r && d.close();
                    },
                    !1
                  )),
          ...
          return (
            n &&
              ((N.filename = n.src),
              n.hasAttribute("data-manual") && (N.manual = !0)),
            N.manual ||
      ...
      we.exports && (we.exports = k),
        ...
        (k.languages.markup.tag.inside["attr-value"].inside.entity =
          k.languages.markup.entity),
        (k.languages.markup.doctype.inside["internal-subset"].inside =
          k.languages.markup),
        k.hooks.add("wrap", function (e) {
          "entity" === e.type &&
        ...
        Object.defineProperty(k.languages.markup.tag, "addInlined", {
          value: function (e, t) {
            ...
            a["language-" + t] = { pattern: /[\s\S]+/, inside: k.languages[t] };
            var r = {};
            (r[e] = {
              pattern: RegExp(
              ...
              k.languages.insertBefore("markup", "cdata", r);
          },
        }),
        (k.languages.html = k.languages.markup),
        (k.languages.mathml = k.languages.markup),
        (k.languages.svg = k.languages.markup),
        (k.languages.xml = k.languages.extend("markup", {})),
        (k.languages.ssml = k.languages.xml),
        (k.languages.atom = k.languages.xml),
        (k.languages.rss = k.languages.xml),
        (function (e) {
          var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
          (e.languages.css = {
            comment: /\/\*[\s\S]*?\*\//,
        ...
        (k.languages.javascript[
          "class-name"
        ][0].pattern = /(\b(?:class|interface|extends|implements|instanceof|new)\s+)[\w.\\]+/),
        k.languages.insertBefore("javascript", "keyword", {
          regex: {
        ...
        k.languages.markup &&
          k.languages.markup.tag.addInlined("script", "javascript"),
        (k.languages.js = k.languages.javascript),
        (k.languages.actionscript = k.languages.extend("javascript", {
          keyword: /\b(?:as|break|case|catch|class|const|default|delete|do|else|extends|finally|for|function|if|implements|import|in|instanceof|interface|internal|is|native|new|null|package|private|protected|public|return|super|switch|this|throw|try|typeof|use|var|void|while|with|dynamic|each|final|get|include|namespace|native|override|set|static)\b/,
          operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/,
        })),
        (k.languages.actionscript["class-name"].alias = "function"),
        k.languages.markup &&
          k.languages.insertBefore("actionscript", "string", {
            xml: {
              pattern: /(^|[^.])<\/?\w+(?:\s+[^\s>\/=]+=("|')(?:\\[\s\S]|(?!\2)[^\\])*\2)*\s*\/?>/,
              lookbehind: !0,
              inside: k.languages.markup,
            },
          }),
        (k.languages.apacheconf = {
          comment: /#.*/,
          "directive-inline": {
        ...
        (k.languages.c = k.languages.extend("clike", {
          comment: {
            pattern: /\/\/(?:[^\r\n\\]|\\(?:\r\n?|\n|(?![\r\n])))*|\/\*[\s\S]*?(?:\*\/|$)/,
            greedy: !0,
          },
        ...
        k.languages.insertBefore("c", "string", {
          macro: {
            pattern: /(^\s*)#\s*[a-z]+(?:[^\r\n\\/]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|\\(?:\r\n|[\s\S]))*/im,
            lookbehind: !0,
            greedy: !0,
            ...
            inside: {
              string: [
                ...
                k.languages.c.string,
              ],
              comment: k.languages.c.comment,
              directive: {
                pattern: /^(#\s*)[a-z]+/,
                lookbehind: !0,
                alias: "keyword",
              ...
              "directive-hash": /^#/,
              punctuation: /##|\\(?=[\r\n])/,
              expression: { pattern: /\S[\s\S]*/, inside: k.languages.c },
            },
          },
          constant: /\b(?:__FILE__|__LINE__|__DATE__|__TIME__|__TIMESTAMP__|__func__|EOF|NULL|SEEK_CUR|SEEK_END|SEEK_SET|stdin|stdout|stderr)\b/,
        }),
        delete k.languages.c.boolean,
        (function (n) {
          function a(e, n) {
          ...
          (n.languages.csharp = n.languages.extend("clike", {
            string: [
              ...
              { pattern: RegExp(S), greedy: !0, alias: "character" },
            ],
            "class-name": [
              {
                pattern: r("(\\busing\\s+static\\s+)<<0>>(?=\\s*;)", [h]),
                lookbehind: !0,
                inside: k,
              },
              {
                pattern: r("(\\busing\\s+<<0>>\\s*=\\s*)<<1>>(?=\\s*;)", [
                  m,
                  w,
                ]),
                lookbehind: !0,
              ...
              {
                pattern: r("(\\busing\\s+)<<0>>(?=\\s*=)", [m]),
                lookbehind: !0,
              },
              {
                pattern: r("(\\b<<0>>\\s+)<<1>>", [d, b]),
                lookbehind: !0,
                inside: k,
              },
              {
                pattern: r("(\\bcatch\\s*\\(\\s*)<<0>>", [h]),
                lookbehind: !0,
                inside: k,
              },
              { pattern: r("(\\bwhere\\s+)<<0>>", [m]), lookbehind: !0 },
              {
                pattern: r("(\\b(?:is(?:\\s+not)?|as)\\s+)<<0>>", [v]),
                lookbehind: !0,
                inside: k,
              },
              {
            ...
            n.languages.insertBefore("csharp", "class-name", {
              ...
              "constructor-invocation": {
                pattern: r("(\\bnew\\s+)<<0>>(?=\\s*[[({])", [w]),
                lookbehind: !0,
                inside: k,
                alias: "class-name",
              },
              "generic-method": {
                pattern: r("<<0>>\\s*<<1>>(?=\\s*\\()", [m, g]),
                inside: {
                  function: r("^<<0>>", [m]),
                  generic: {
                    pattern: RegExp(g),
        ...
        (k.languages.dotnet = k.languages.cs = k.languages.csharp),
        ...
        ((t = k).languages.cpp = t.languages.extend("c", {
          "class-name": [
            {
              pattern: RegExp(
        ...
        ((a = k).languages.coffeescript = a.languages.extend("javascript", {
          comment: r,
          string: [
        ...
        a.languages.insertBefore("coffeescript", "comment", {
          ...
          "block-regex": {
            pattern: /\/{3}[\s\S]*?\/{3}/,
            alias: "regex",
            inside: { comment: r, interpolation: i },
          },
        }),
                    ...
                    (p.content && "string" == typeof p.content)
                      ? ((a = b[m]),
                        ...
                        -1 < (s = i.indexOf(o)) &&
                          ...
                          (u = i.substring(s + o.length)),
                          (c = []),
                          l && c.push.apply(c, e([l])),
                          c.push(d),
                          u && c.push.apply(c, e([u])),
                          "string" == typeof p
                            ? t.splice.apply(t, [n, 1].concat(c))
                            : (p.content = c)))
        ...
        (k.languages.dockerfile = k.languages.docker),
        (k.languages.elixir = {
          comment: /#.*/m,
          regex: {
        ...
        k.languages.elixir.string.forEach(function (e) {
          e.inside = {
            interpolation: {
              pattern: /#\{[^}]+\}/,
              inside: {
                delimiter: { pattern: /^#\{|\}$/, alias: "punctuation" },
                rest: k.languages.elixir,
              },
            },
          };
        }),
        ...
        (k.languages.fsharp = k.languages.extend("clike", {
          comment: [
            { pattern: /(^|[^\\])\(\*[\s\S]*?\*\)/, lookbehind: !0 },
            { pattern: /(^|[^\\:])\/\/.*/, lookbehind: !0 },
          ],
        ...
        k.languages.insertBefore("fsharp", "keyword", {
          preprocessor: {
            pattern: /^[^\r\n\S]*#.*/m,
            alias: "property",
            inside: {
        ...
        k.languages.insertBefore("fsharp", "punctuation", {
          "computation-expression": {
            pattern: /[_a-z]\w*(?=\s*\{)/i,
            alias: "keyword",
          },
        }),
        k.languages.insertBefore("fsharp", "string", {
          annotation: {
            pattern: /\[<.+?>\]/,
            inside: {
              punctuation: /^\[<|>\]$/,
              ...
              "annotation-content": {
                pattern: /[\s\S]+/,
                inside: k.languages.fsharp,
              },
            },
          },
        }),
        ((o = k).languages.flow = o.languages.extend("javascript", {})),
        ...
        Array.isArray(o.languages.flow.keyword) ||
          (o.languages.flow.keyword = [o.languages.flow.keyword]),
        ...
        (k.languages.go = k.languages.extend("clike", {
        ...
        delete k.languages.go["class-name"],
        (k.languages.graphql = {
          comment: /#.*/,
          description: {
            pattern: /(?:"""(?:[^"]|(?!""")")*"""|"(?:\\.|[^\\"\r\n])*")(?=\s*[a-z_])/i,
        ...
        (function (e) {
          ...
          for (
            ...
            var i =
              "string" == typeof (i = t[a]) ? { filter: i, language: i } : i;
        ...
        s.hooks.add("before-tokenize", function (e) {
          s.languages["markup-templating"].buildPlaceholders(
            e,
            "handlebars",
            /\{\{\{[\s\S]+?\}\}\}|\{\{[\s\S]+?\}\}/g
          );
        ...
        s.hooks.add("after-tokenize", function (e) {
          s.languages["markup-templating"].tokenizePlaceholders(
            e,
            "handlebars"
          );
        }),
        ...
        (k.languages.hs = k.languages.haskell),
        (function (e) {
          e.languages.http = {
            "request-line": {
        ...
        (u = /\b[A-Z](?:\w*[a-z]\w*)?\b/),
        ((l = k).languages.java = l.languages.extend("clike", {
          "class-name": [u, /\b[A-Z]\w*(?=\s+\w+\s*[;,=())])/],
          keyword: d,
          function: [
        ...
        (k.languages.webmanifest = k.languages.json),
        (function (e) {
        ...
        ((c = k).languages.latex = {
          ...
          function: { pattern: p, alias: "selector" },
          punctuation: /[[\]{}&]/,
        }),
        (c.languages.tex = c.languages.latex),
        (c.languages.context = c.languages.latex),
        (k.languages.less = k.languages.extend("css", {
          comment: [
            /\/\*[\s\S]*?\*\//,
            { pattern: /(^|[^\\])\/\/.*/, lookbehind: !0 },
          ],
        ...
        k.languages.insertBefore("less", "property", {
          variable: [
        ...
        (y =
          "\\|?[ \t]*:?-{3,}:?[ \t]*(?:\\|[ \t]*:?-{3,}:?[ \t]*)+\\|?(?:\n|\r\n?)"),
        (f.languages.markdown = f.languages.extend("markup", {})),
        f.languages.insertBefore("markdown", "prolog", {
          blockquote: { pattern: /^>(?:[\t ]*>)*/m, alias: "punctuation" },
          table: {
            pattern: RegExp("^" + b + y + "(?:" + b + ")*", "m"),
            inside: {
              "table-data-rows": {
                pattern: RegExp("^(" + b + y + ")(?:" + b + ")*$"),
                lookbehind: !0,
                inside: {
                  "table-data": {
                    pattern: RegExp(m),
                    inside: f.languages.markdown,
                  },
                  punctuation: /\|/,
                },
              },
        ...
        ["url", "bold", "italic", "strike"].forEach(function (t) {
          ["url", "bold", "italic", "strike"].forEach(function (e) {
            t !== e &&
              (f.languages.markdown[t].inside.content.inside[e] =
                f.languages.markdown[e]);
          });
        }),
        f.hooks.add("after-tokenize", function (e) {
          ...
          if ("code-block" === e.type) {
            ...
            l
              ? ((o = e.content.replace(/&lt;/g, "<").replace(/&amp;/g, "&")),
                (e.content = f.highlight(o, l, t)))
              : t &&
                "none" !== t &&
                f.plugins.autoloader &&
                ((s =
                  "md-" +
                  new Date().valueOf() +
                  "-" +
                ...
                (e.attributes.id = s),
                f.plugins.autoloader.loadLanguages(t, function () {
                  var e = document.getElementById(s);
                  e &&
                    (e.innerHTML = f.highlight(
                      e.textContent,
                      f.languages[t],
                      t
                    ));
        ...
        (f.languages.md = f.languages.markdown),
        (k.languages.objectivec = k.languages.extend("c", {
          keyword: /\b(?:asm|typeof|inline|auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|int|long|register|return|short|signed|sizeof|static|struct|switch|typedef|union|unsigned|void|volatile|while|in|self|super)\b|(?:@interface|@end|@implementation|@protocol|@class|@public|@protected|@private|@property|@try|@catch|@finally|@throw|@synthesize|@dynamic|@selector)\b/,
          string: /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1|@"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"/,
          operator: /-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|\|?|[~^%?*\/@]/,
        })),
        delete k.languages.objectivec["class-name"],
        (k.languages.objc = k.languages.objectivec),
        (k.languages.ocaml = {
          comment: /\(\*[\s\S]*?\*\)/,
          string: [
            { pattern: /"(?:\\.|[^\\\r\n"])*"/, greedy: !0 },
        ...
        (function (t) {
          ...
          t.languages.insertBefore("php", "variable", { string: s }),
        ...
        k.languages.insertBefore("php", "variable", {
          this: /\$this\b/,
        ...
        ((w = v.string[0].inside).boolean = v.boolean),
        (w.variable = v.variable),
        (w.function.inside = v),
        (k.languages.processing = k.languages.extend("clike", {
          keyword: /\b(?:break|catch|case|class|continue|default|else|extends|final|for|if|implements|import|new|null|private|public|return|static|super|switch|this|try|void|while)\b/,
          operator: /<[<=]?|>[>=]?|&&?|\|\|?|[%?]|[!=+\-*\/]=?/,
        })),
        k.languages.insertBefore("processing", "number", {
        ...
        (k.languages.processing.function = /\w+(?=\s*\()/),
        (k.languages.processing["class-name"].alias = "variable"),
        (function (e) {
          e.languages.pug = {
            comment: {
              pattern: /(^([\t ]*))\/\/.*(?:(?:\r?\n|\r)\2[\t ]+.+)*/m,
        ...
        (k.languages.python[
          "string-interpolation"
        ].inside.interpolation.inside.rest = k.languages.python),
        (k.languages.py = k.languages.python),
        (k.languages.r = {
          comment: /#.*/,
          string: { pattern: /(['"])(?:\\.|(?!\1)[^\\\r\n])*\1/, greedy: !0 },
        ...
        (function (s) {
          ...
          (s.languages.jsx = s.languages.extend("markup", e)),
            (s.languages.jsx.tag.pattern = /<\/?(?:[\w.:-]+\s*(?:\s+(?:[\w.:$-]+(?:=(?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s{'">=]+|\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\}))?|\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}))*\s*\/?)?>/i),
            (s.languages.jsx.tag.inside.tag.pattern = /^<\/?[^\s>\/]*/i),
            (s.languages.jsx.tag.inside[
              "attr-value"
            ].pattern = /=(?!\{)(?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s'">]+)/i),
            (s.languages.jsx.tag.inside.tag.inside[
              "class-name"
            ] = /^[A-Z]\w*(?:\.[A-Z]\w*)*$/),
                  ...
                  "string" != typeof i &&
                      ...
                      ? "</" === i.content[0].content[0].content
                        ? 0 < n.length &&
                          n[n.length - 1].tagName ===
                            l(i.content[0].content[1]) &&
                          n.pop()
                        : "/>" === i.content[i.content.length - 1].content ||
                          n.push({
                            tagName: l(i.content[0].content[1]),
                            openedBraces: 0,
                          })
                      : 0 < n.length &&
                        "punctuation" === i.type &&
                    ...
                    (o || "string" == typeof i) &&
                      ...
                      a < t.length - 1 &&
                        ...
                        ((r += l(t[a + 1])), t.splice(a + 1, 1)),
                      0 < a &&
                        ("string" == typeof t[a - 1] ||
                          "plain-text" === t[a - 1].type) &&
                        ((r = l(t[a - 1]) + r), t.splice(a - 1, 1), a--),
                      (t[a] = new s.Token("plain-text", r, null, r))),
                    i.content && "string" != typeof i.content && e(i.content);
                }
              })(e.tokens);
          });
        })(k),
      ...
      var x,
        ...
        ie,
        oe,
        se = k.util.clone(k.languages.typescript);
      function le(e) {
      ...
      function ge(d, e, u) {
        var t = (e = "string" == typeof e ? e : d.getAttribute("data-line"))
            .replace(/\s+/g, "")
            .split(",")
            .filter(Boolean),
          c = +d.getAttribute("data-line-offset") || 0,
          p = (D() ? parseInt : parseFloat)(getComputedStyle(d).lineHeight),
          g = ce(d, "line-numbers"),
        ...
        t.forEach(function (e) {
          var t,
            ...
            s = +i[1] || o,
            l =
              d.querySelector('.line-highlight[data-range="' + e + '"]') ||
              document.createElement("div");
          m.push(function () {
            l.setAttribute("aria-hidden", "true"),
              l.setAttribute("data-range", e),
              (l.className = (u || "") + " line-highlight");
          }),
            g && k.plugins.lineNumbers
              ? ((t = k.plugins.lineNumbers.getLine(d, o)),
                (n = k.plugins.lineNumbers.getLine(d, s)),
                t &&
                  ((a = t.offsetTop + "px"),
                  m.push(function () {
                    l.style.top = a;
                ...
                n &&
                  ((r = n.offsetTop - t.offsetTop + n.offsetHeight + "px"),
                  m.push(function () {
                    l.style.height = r;
                  })))
              : m.push(function () {
                  l.setAttribute("data-start", o),
                    o < s && l.setAttribute("data-end", s),
                    (l.style.top = (o - c - 1) * p + "px"),
                    (l.textContent = new Array(s - o + 2).join(" \n"));
                }),
            m.push(function () {
              f.appendChild(l);
            });
        ...
        var a = d.id;
        if (g && a) {
          for (var r, n = "linkable-line-numbers", i = !1, o = d; o; ) {
            if (ce(o, n)) {
              i = !0;
              break;
            }
          ...
          i &&
            ...
            (r = parseInt(d.getAttribute("data-start") || "1")),
            ue(".line-numbers-rows > span", d).forEach(function (e, t) {
              var n = t + r;
              e.onclick = function () {
                var e = a + "." + n;
                (P = !1),
      ...
      function fe() {
        ...
        ue(".temporary.line-highlight").forEach(function (e) {
      ...
      function he(e) {
        if ("function" == typeof e) {
          ...
          for (var n, t = 0; (n = j[t++]); ) if (n.name === e) return n.adapter;
        return null;
      }
      function ye(e, t) {
      ...
      (k.languages.tsx = k.languages.extend("jsx", se)),
        (k.languages.reason = k.languages.extend("clike", {
          string: {
            pattern: /"(?:\\(?:\r\n|[\s\S])|[^\\\r\n"])*"/,
            greedy: !0,
          },
        ...
        k.languages.insertBefore("reason", "class-name", {
          character: {
        ...
        delete k.languages.reason.function,
        (function (e) {
          for (
            var t = "/\\*(?:[^*/]|\\*(?!/)|/(?!\\*)|<self>)*\\*/", n = 0;
            n < 2;
        ...
        (k.languages.scss = k.languages.extend("css", {
          comment: {
            pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
            lookbehind: !0,
          },
        ...
        k.languages.insertBefore("scss", "atrule", {
          keyword: [
            /@(?:if|else(?: if)?|for|each|while|import|extend|debug|warn|mixin|include|function|return|content)/i,
            { pattern: /( +)(?:from|through)(?= )/, lookbehind: !0 },
          ],
        }),
        k.languages.insertBefore("scss", "important", {
          variable: /\$[-\w]+|#\{\$[-\w]+\}/,
        }),
        k.languages.insertBefore("scss", "function", {
        ...
        (k.languages.scss.atrule.inside.rest = k.languages.scss),
        (k.languages.scheme = {
          comment: /;.*|#;\s*\((?:[^()]|\([^()]*\))*\)|#\|(?:[^#|]|#(?!\|)|\|(?!#)|#\|(?:[^#|]|#(?!\|)|\|(?!#))*\|#)*\|#/,
          string: { pattern: /"(?:[^"\\]|\\.)*"/, greedy: !0 },
        ...
        ((T = {
          ...
          color: [
            /\b(?:AliceBlue|AntiqueWhite|Aqua|Aquamarine|Azure|Beige|Bisque|Black|BlanchedAlmond|Blue|BlueViolet|Brown|BurlyWood|CadetBlue|Chartreuse|Chocolate|Coral|CornflowerBlue|Cornsilk|Crimson|Cyan|DarkBlue|DarkCyan|DarkGoldenRod|DarkGr[ae]y|DarkGreen|DarkKhaki|DarkMagenta|DarkOliveGreen|DarkOrange|DarkOrchid|DarkRed|DarkSalmon|DarkSeaGreen|DarkSlateBlue|DarkSlateGr[ae]y|DarkTurquoise|DarkViolet|DeepPink|DeepSkyBlue|DimGr[ae]y|DodgerBlue|FireBrick|FloralWhite|ForestGreen|Fuchsia|Gainsboro|GhostWhite|Gold|GoldenRod|Gr[ae]y|Green|GreenYellow|HoneyDew|HotPink|IndianRed|Indigo|Ivory|Khaki|Lavender|LavenderBlush|LawnGreen|LemonChiffon|LightBlue|LightCoral|LightCyan|LightGoldenRodYellow|LightGr[ae]y|LightGreen|LightPink|LightSalmon|LightSeaGreen|LightSkyBlue|LightSlateGr[ae]y|LightSteelBlue|LightYellow|Lime|LimeGreen|Linen|Magenta|Maroon|MediumAquaMarine|MediumBlue|MediumOrchid|MediumPurple|MediumSeaGreen|MediumSlateBlue|MediumSpringGreen|MediumTurquoise|MediumVioletRed|MidnightBlue|MintCream|MistyRose|Moccasin|NavajoWhite|Navy|OldLace|Olive|OliveDrab|Orange|OrangeRed|Orchid|PaleGoldenRod|PaleGreen|PaleTurquoise|PaleVioletRed|PapayaWhip|PeachPuff|Peru|Pink|Plum|PowderBlue|Purple|Red|RosyBrown|RoyalBlue|SaddleBrown|Salmon|SandyBrown|SeaGreen|SeaShell|Sienna|Silver|SkyBlue|SlateBlue|SlateGr[ae]y|Snow|SpringGreen|SteelBlue|Tan|Teal|Thistle|Tomato|Transparent|Turquoise|Violet|Wheat|White|WhiteSmoke|Yellow|YellowGreen)\b/i,
            {
              pattern: /\b(?:rgb|hsl)\(\s*\d{1,3}\s*,\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*\)\B|\b(?:rgb|hsl)a\(\s*\d{1,3}\s*,\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*,\s*(?:0|0?\.\d+|1)\s*\)\B/i,
              inside: {
                unit: (A = { pattern: /(\b\d+)(?:%|[a-z]+)/, lookbehind: !0 }),
                number: (_ = {
                  pattern: /(^|[^\w.-])-?\d*\.?\d+/,
                  lookbehind: !0,
                }),
        ...
        (k.languages.swift = k.languages.extend("clike", {
          string: {
            pattern: /("|')(?:\\(?:\((?:[^()]|\([^)]+\))+\)|\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
            greedy: !0,
            inside: {
        ...
        (k.languages.swift.string.inside.interpolation.inside.rest =
          k.languages.swift),
        (function () {
          function e(e, t) {
            return RegExp(
          ...
          var t = {
              css: { pattern: /\{[^}]+\}/, inside: { rest: k.languages.css } },
              "class-id": {
                pattern: /(\()[^)]+(?=\))/,
                lookbehind: !0,
                alias: "attr-value",
            ...
            n = (k.languages.textile = k.languages.extend("markup", {
              phrase: {
                pattern: /(^|\r|\n)\S[\s\S]*?(?=$|\r?\n\r?\n|\r\r)/,
                lookbehind: !0,
                inside: {
        ...
        (k.languages.twig = {
          ...
          other: { pattern: /\S(?:[\s\S]*\S)?/, inside: k.languages.markup },
        }),
        (k.languages.vim = {
          string: /"(?:[^"\\\r\n]|\\.)*"|'(?:[^'\r\n]|'')*'/,
          comment: /".*/,
        ...
        (k.languages.vb = k.languages["visual-basic"]),
        (k.languages.vba = k.languages["visual-basic"]),
        (k.languages.wasm = {
        ...
        (I =
          ...
          L.source +
          ")?)"),
        (N = "(?:[^\\s\\x00-\\x08\\x0e-\\x1f!\"#%&'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ \t]*(?:(?![#:])<PLAIN>|:<PLAIN>))*".replace(
          /<PLAIN>/g,
          function () {
        ...
        (C.languages.yaml = {
          ...
          string: { pattern: de(O), lookbehind: !0, greedy: !0 },
          number: {
            pattern: de(
        ...
        "undefined" != typeof self &&
          ...
          (P = !0),
          (B = 0),
          k.hooks.add("before-sanity-check", function (e) {
            var t,
            ...
            n &&
              ...
              ((t = 0),
              ue(".line-highlight", n).forEach(function (e) {
          ...
          k.hooks.add("complete", function e(t) {
            var n,
              a,
              r = t.element.parentNode,
              i = r && r.getAttribute("data-line");
            r &&
              i &&
              /pre/i.test(r.nodeName) &&
              (clearTimeout(B),
              (n = k.plugins.lineNumbers),
              (a = t.plugins && t.plugins.lineNumbers),
              ce(r, "line-numbers") && n && !a
                ? k.hooks.add("line-numbers", e)
                : (ge(r, i)(), (B = setTimeout(fe, 1))));
          }),
        ...
        "undefined" != typeof self &&
          ...
          ((M = "line-numbers"),
          ($ = /\n(?!$)/g),
          (z = k.plugins.lineNumbers = {
            getLine: function (e, t) {
              if ("PRE" === e.tagName && e.classList.contains(M)) {
                var n = e.querySelector(".line-numbers-rows"),
                  a = parseInt(e.getAttribute("data-start"), 10) || 1,
                  r = a + (n.children.length - 1);
                t < a && (t = a), r < t && (t = r);
                var i = t - a;
                return n.children[i];
              }
          ...
          (U = void 0),
          window.addEventListener("resize", function () {
            (z.assumeViewportIndependence && U === window.innerWidth) ||
              ((U = window.innerWidth),
              me(
                Array.prototype.slice.call(
                  document.querySelectorAll("pre." + M)
                )
              ));
          }),
          k.hooks.add("complete", function (e) {
            var t, n, a, r, i, o;
            !e.code ||
              ((n = (t = e.element).parentNode) &&
                /pre/i.test(n.nodeName) &&
                !t.querySelector(".line-numbers-rows") &&
                k.util.isActive(t, M) &&
                (t.classList.remove(M),
                n.classList.add(M),
                (i = (r = e.code.match($)) ? r.length + 1 : 1),
                (o = new Array(i + 1).join("<span></span>")),
                ...
                me([n]),
                k.hooks.run("line-numbers", e)));
          }),
          k.hooks.add("line-numbers", function (e) {
        ...
        "undefined" != typeof self &&
          ...
          (K =
            ...
            (Z = "loading") +
            '"])'),
          k.hooks.add("before-highlightall", function (e) {
            e.selector += ", " + K;
          }),
          k.hooks.add("before-sanity-check", function (e) {
            var r = e.element;
            if (r.matches(K)) {
              (e.code = ""), r.setAttribute(H, Z);
              var i = r.appendChild(document.createElement("CODE"));
              i.textContent = "Loading…";
              var t = e.language;
              i.className = "language-" + t;
              var n = k.plugins.autoloader;
              n && n.loadLanguages(t);
              ...
              var s = "prismjsonp" + G++,
                ...
                d = (l.href = r.getAttribute("data-jsonp"));
              l.href +=
                (l.search ? "&" : "?") +
              ...
              var u = setTimeout(function () {
                  r.setAttribute(H, W),
                    (i.textContent = "✖ Error: Timeout loading " + d);
                }, k.plugins.jsonphighlight.timeout),
              ...
              (c.src = l.href),
                (window[s] = function (e) {
                  ...
                  null === t
                    ...
                    : (r.setAttribute(H, "loaded"),
                      (i.textContent = t),
                      k.highlightElement(i));
                }),
                document.head.appendChild(c);
            }
          }),
          (k.plugins.jsonphighlight = {
            timeout: 5e3,
            registerAdapter: be,
            removeAdapter: function (t) {
              var e;
              "string" == typeof t && (t = he(t)),
                "function" == typeof t &&
                  0 <=
                    (e = j.findIndex(function (e) {
                      return e.adapter === t;
                    })) &&
                  j.splice(e, 1);
            },
            highlight: function (e) {
              for (
                var t, n = (e || document).querySelectorAll(K), a = 0;
                (t = n[a++]);

              )
                k.highlightElement(t);
            },
          })),
        "undefined" != typeof self &&
          self.Prism &&
          ...
          k.hooks.add("before-highlight", function (e) {
            var t = ve(e);
            if (!t.complete && e.code) {
              ...
              if (
                n &&
                /pre/i.test(n.nodeName) &&
                (V.test(n.className) || V.test(e.element.className))
              ) {
                var a = e.element.querySelector("." + Y);
                a && a.remove();
                var i = e.code.split("\n");
                t.numberOfLines = i.length;
                var o = (t.outputLines = []),
                ...
                if (null !== r)
                  r.split(",").forEach(function (e) {
                    ...
                    if (!isNaN(n) && !isNaN(a)) {
                      n < 1 && (n = 1), a > i.length && (a = i.length), a--;
                      for (var r = --n; r <= a; r++) (o[r] = i[r]), (i[r] = "");
                    }
                  });
                else if (s)
                  for (var l = 0; l < i.length; l++)
                    X(i[l], s) && ((o[l] = i[l].slice(s.length)), (i[l] = ""));
                e.code = i.join("\n");
              } else t.complete = !0;
            } else t.complete = !0;
          }),
          k.hooks.add("before-insert", function (e) {
            var t = ve(e);
            if (!t.complete) {
              for (
          ...
          k.hooks.add("complete", function (e) {
            ...
            if (!t.complete) {
              var n = e.element.parentElement;
              V.test(e.element.className) &&
                (e.element.className = e.element.className.replace(V, " ")),
                V.test(n.className) || (n.className += " command-line");
              var a = t.numberOfLines || 0,
                r = c("data-prompt", ""),
                i = ye(
                  "" !== r
                    ? '<span data-prompt="' + r + '"></span>'
                    : '<span data-user="' +
                        c("data-user", "user") +
                        '" data-host="' +
              ...
              (o.className = Y), (o.innerHTML = i);
              for (
                var s, l = t.outputLines || [], d = 0, u = l.length;
                d < u;
                d++
              ) {
                l.hasOwnProperty(d) &&
                  ((s = o.children[d]).removeAttribute("data-user"),
                  s.removeAttribute("data-host"),
                  s.removeAttribute("data-prompt"));
              }
        ...
        "undefined" != typeof self &&
          ...
          (ee = function () {}),
          (k.plugins.toolbar = {}),
          (te = k.plugins.toolbar.registerButton = function (e, n) {
            var t =
              "function" == typeof n
                ? n
                : function (e) {
          ...
          (ne = k.plugins.toolbar.hook = function (a) {
            var e,
              r,
              t,
              n,
              i = a.element.parentNode;
            i &&
          ...
          k.hooks.add("complete", ne)),
        "undefined" != typeof self &&
          self.Prism &&
          self.document &&
          (k.plugins.toolbar
            ? ((ae = (ae = window.ClipboardJS || void 0) || ke(4)),
              (re = []),
              ae ||
                ((ie = document.createElement("script")),
                (oe = document.querySelector("head")),
                (ie.onload = function () {
                  if ((ae = window.ClipboardJS)) for (; re.length; ) re.pop()();
                }),
                (ie.src =
                  "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js"),
                oe.appendChild(ie)),
              k.plugins.toolbar.registerButton(
                "copy-to-clipboard",
                function (e) {
                  var t = document.createElement("button");
                  (t.textContent = "Copy"), t.setAttribute("type", "button");
                  var n = e.element;
                  return ae ? a() : re.push(a), t;
                  function a() {
                    var e = new ae(t, {
                      text: function () {
        ...
        (r.m = n = [
          ...
          function (e, t, n) {
            ...
            e.exports = function (e, t, n) {
              ...
              if (p.string(e))
                return (a = e), (r = t), (i = n), g(document.body, a, r, i);
              throw new TypeError(
                "First argument must be a String, HTMLElement, HTMLCollection, or NodeList"
              );
              var a, r, i, o, s, l, d, u, c;
            };
          },
          function (e, n) {
            (n.node = function (e) {
